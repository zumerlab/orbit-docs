import { a as createTemplate, b as addTextareaListener } from "../index-BltwYS88.js";
import { getLineBefore } from "../utils/index.js";
import { s as scrollToEl, b as getLineEnd } from "../local-VpqO7_GV.js";
...
const cursorPosition = () => {
  ...
  const self = (editor) => {
    ...
    if (editor.activeLine)
      selectionChange(editor.getSelection());
  };
  self.getPosition = () => {
