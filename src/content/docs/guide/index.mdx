...
4. **Adding radial elements.**
    ...
    Each orbit can contain **radial elements** such as [`satellites`](/orbit-docs/elements/satellite),[`arcs`](/orbit-docs/elements/arc/), [`vectors`](/orbit-docs/elements/vector), [`curved texts`](/orbit-docs/elements/arc/#rendering-curved-text),[ `progress`](/orbit-docs/elements/progress) indicators, and [`sides`](/orbit-docs/elements/side). These elements are evenly distributed along the orbit's perimeter, allowing for detailed radial designs tailored to specific needs.
