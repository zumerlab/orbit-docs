...
description: Build an 8-fold radial mandala with concentric satellite rings and triangular sides with Orbit and CSS. Decorative pattern, no handwritten SVG required.
---
...
[Install Orbit](/orbit-docs/introduction/installation/) and the markup above gives you the entire pattern.
