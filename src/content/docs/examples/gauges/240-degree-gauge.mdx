...
description: Build a 240-degree speedometer gauge in HTML and CSS with numbered tick marks and a needle. Compose it with Orbit classes and CSS custom properties.
---
...
[Install Orbit](/orbit-docs/introduction/installation/) to get the `<o-arc>` element and orbit primitives used above.
