...
description: An Orbit fuel gauge with E/F labels, warning ticks and a red needle on a black background. HTML and CSS styling with the Orbit runtime.
---
...
[Install Orbit](/orbit-docs/introduction/installation/) and grab the markup above as a starting point.
