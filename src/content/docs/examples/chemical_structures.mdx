...
description: Render a caffeine molecule (purine ring system, methyl groups, double bonds) as a CSS diagram. HTML and CSS composition with Orbit — no chemistry library needed.
---
...
[Install Orbit](/orbit-docs/introduction/installation/) and the markup above is your full caffeine diagram.
