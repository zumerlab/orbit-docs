            ...
            <div class="satellite">
              <div class="capsule">
                <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="30px"
                  fill="#fff"><path d="M313.33-80q-14.16 0-23.75-9.58-9.58-9.59-9.58-23.75v-664q0-14.17 9.58-23.75 9.59-9.59 23.75-9.59H400V-880h160v69.33h86.67q14.16 0 23.75 9.59 9.58 9.58 9.58 23.75v664q0 14.16-9.58 23.75Q660.83-80 646.67-80H313.33Zm33.34-493.33h266.66V-744H346.67v170.67Z" />
                </svg>
                <span>63%</span>
              </div>
            </div>
            ...
            <div class="satellite">
              <div class="capsule">
                <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px"
                  fill="#fff"><path d="m280-400 200-200.67L680-400H280Z" />
                </svg>
                <span>12º</span>
                <span>5º</span>
                <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px"
                  fill="#fff"><path d="M480-360 280-559.33h400L480-360Z" />
                </svg>
              </div>
            </div>
          </div>
    ...
    <div class="orbit-8">
      <div class="satellite grow-8x at-center main">
        <div class="capsule">
          ...
          <span class="place">Constanta | 12º</span>
...
<ZumerPlay name={'dps'}   htmlCode={dashboardHTML}  cssCode={dashboardCSS} height={'600px'} />
