...
<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={dashboardHTML} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={dashboardCSS} lang="css" />
  </TabItem>
</Tabs>

**Codepen**: <a href="https://codepen.io/zircle/pen/abegbaw" target="_blank">link</a> 
...
<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={watchHTML} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={watchCSS} lang="css" />
  </TabItem>
  <TabItem label="JS" icon="seti:js">
    <Code code={watchJS} lang="js" />
  </TabItem>
</Tabs>
