...
description: Build a rotary knob with a continuous green progress arc with Orbit. Tick marks, textured body and a CSS-themed progress arc.
---
...
This example builds the knob body from a textured background, places ten tick marks around it, and overlays an `<o-progress>` arc that visually fills as the value rises. Orbit renders the SVG progress arc and maintains the layout. The extra JavaScript in the third tab generates the tick marks for brevity.
