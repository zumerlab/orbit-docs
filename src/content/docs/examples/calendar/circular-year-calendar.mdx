...
description: Build a year-at-a-glance circular calendar with months, days, seasons and a centered year label with Orbit and CSS. No SVG required.
---
...
[Install Orbit](/orbit-docs/introduction/installation/) and the markup above gives you the entire calendar dial.
