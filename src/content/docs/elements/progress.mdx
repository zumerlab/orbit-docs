...
To change o-progress **progress bar** color use CSS custom var `--o-progress-color` and `--hover-progress-color` in a `o-progress` style. Use `--o-bg-color` to set a **background bar** color.
...
<div class="wrapper">
  <div class="bigbang">
    <div class="gravity-spot">
      <div class="orbit-3">
        <o-progress value="" class="grow-1x purple-light" shape="circle"></o-progress>
      </div>
    </div>
  </div>
</div>
<div class="wrapper">
  <div class="bigbang">
    <div class="gravity-spot">
      <div class="orbit-3">
        <o-progress value="" class="grow-1x purple-light" shape="arrow"></o-progress>
      </div>
    </div>
  </div>
</div>
<div class="wrapper">
  <div class="bigbang">
    <div class="gravity-spot">
      <div class="orbit-3">
        <o-progress value="" class="grow-1x purple-light" shape="zigzag"></o-progress>
      </div>
    </div>
  </div>
</div>
<div class="wrapper">
  <div class="bigbang">
    <div class="gravity-spot">
      <div class="orbit-3">
        <o-progress value="" class="grow-1x purple-light" shape="slash"></o-progress>
      </div>
    </div>
  </div>
</div>
<div class="wrapper">
  <div class="bigbang">
    <div class="gravity-spot">
      <div class="orbit-3">
        <o-progress value="" class="grow-1x purple-light" shape="backslash"></o-progress>
      </div>
    </div>
  </div>
</div>
