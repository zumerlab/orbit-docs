...
<ZumerPlay name={'orbitSize'} hideCode htmlCode={orbitSize} cssCode={orbitSizeCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={orbitSize} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={orbitSizeCSS} lang="css" />
  </TabItem>
</Tabs>
...
<div class="bigbang">
  <div class="gravity-spot at-center-left" style="--o-force:100px">
...
<ZumerPlay name={'ellipse'} hideCode htmlCode={ellipse} cssCode={ellipseCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={ellipse} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={ellipseCSS} lang="css" />
  </TabItem>
</Tabs>
...
<ZumerPlay name={'distribution'} hideCode htmlCode={distribution} cssCode={distributionCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={distribution} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={distributionCSS} lang="css" />
  </TabItem>
</Tabs>
