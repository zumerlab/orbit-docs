...
:::note
Orbit children elements include `.satellite`, `.vector`, `.side`, `o-slice`, and `o-text`.  
:::
...
:::note
`.range-*` affects `.satellite`, `.vector`, `.side`, `o-slice`, and `o-text`.  
:::
...
<ZumerPlay name={'range'} hideCode htmlCode={range} cssCode={rangeCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={range} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={rangeCSS} lang="css" />
  </TabItem>
</Tabs>
...
<ZumerPlay name={'fit'} hideCode htmlCode={fit} cssCode={fitCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={fit} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={fitCSS} lang="css" />
  </TabItem>
</Tabs>
...
<ZumerPlay name={'ccw'} hideCode htmlCode={ccw} cssCode={ccwCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={ccw} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={ccwCSS} lang="css" />
  </TabItem>
</Tabs>
...
<ZumerPlay name={'gooey'} hideCode htmlCode={gooey} cssCode={gooeyCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={gooey} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code code={gooeyCSS} lang="css" />
  </TabItem>
</Tabs>
