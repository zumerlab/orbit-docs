...
<ZumerPlay name={'bg'} hideCode htmlCode={bg} cssCode={bgCSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={bg} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code wrap code={bgCSS} lang="css" />
  </TabItem>
</Tabs>
...
<ZumerPlay name={'bg1'} hideCode htmlCode={bg1} cssCode={bg1CSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={bg1} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code wrap code={bg1CSS} lang="css" />
  </TabItem>
</Tabs>
...
<ZumerPlay name={'bg2'} hideCode htmlCode={bg2} cssCode={bg2CSS} theme={'cyan-theme'} height={'300px'} />

<Tabs>
  <TabItem label="HTML" icon="seti:html">
    <Code code={bg2} lang="html" />
  </TabItem>
  <TabItem label="CSS" icon="seti:css">
    <Code wrap code={bg2CSS} lang="css" />
  </TabItem>
</Tabs>
