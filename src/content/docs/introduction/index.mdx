...
Orbit builds radial interfaces with CSS geometry and a small JavaScript runtime. It provides intuitive CSS classes and standard web components for building radial menus, dashboards, creative portfolios, or cutting-edge applications. Whether you’re crafting a futuristic dashboard, an elegant watch face, or even sci-fi-inspired art, Orbit has you covered.
...
Compose radial interfaces with HTML classes and CSS custom properties. Orbit calculates placement for you: CSS positions the elements, while JavaScript updates ring numbering, spacing and SVG paths after DOM changes or container resizes. You can concentrate on the interface and its behavior.
