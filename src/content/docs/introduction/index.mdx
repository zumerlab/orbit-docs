...
<a href="/examples/radial-menu" target="_blank">Radial menu</a>

<a href="/examples/color-selector" target="_blank">Color selector</a>

<a href="/examples/chronodex" target="_blank">Chronodex</a>

<a href="/examples/watch" target="_blank">Analog watch</a>

<a href="/examples/simon-game" target="_blank">Simon game</a>

<a href="/examples/car-dashboard" target="_blank">Car dashboard</a>

<Orbit>
 
        <div id="example" class="o-container" style="--o-radius: 60px">
        <div id="pointer" class="o-orbit framex">
                    <div class="o-orbiter o-xxs pointer o-upper"><div class="o-content" style="rotate: 90deg">▲</div>   </div>
          
            </div>
            <div class="o-orbit ">
                    <div class="o-orbiter o-xxs dot"><div class="o-content">  Radial menu</div></div>
                    <div class="o-orbiter o-xxs dot"><div class="o-content">Color wheel</div></div>
                    <div class="o-orbiter o-xxs dot"><div class="o-content">Car dasboard</div></div>
                    <div class="o-orbiter o-xxs dot"><div class="o-content">Simon game</div></div>
                    <div class="o-orbiter o-xxs dot"><div class="o-content">Watch</div></div>
